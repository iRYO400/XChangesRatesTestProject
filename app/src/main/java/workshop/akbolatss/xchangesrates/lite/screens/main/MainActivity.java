package workshop.akbolatss.xchangesrates.lite.screens.main;
...
import workshop.akbolatss.xchangesrates.lite.app.ApplicationMain;
import workshop.akbolatss.xchangesrates.lite.model.BPIResponse;
import workshop.akbolatss.xchangesrates.lite.model.CoindeskResponse;
import workshop.akbolatss.xchangesrates.lite.utils.DateXValueFormatter;

import static workshop.akbolatss.xchangesrates.lite.utils.Constants.HAWK_CURRENCY_POS;
import static workshop.akbolatss.xchangesrates.lite.utils.Constants.HAWK_CURRENCY_RATE;
import static workshop.akbolatss.xchangesrates.lite.utils.Constants.HAWK_HISTORY;
import static workshop.akbolatss.xchangesrates.lite.utils.Constants.ONE_MONTH_AGO;
import static workshop.akbolatss.xchangesrates.lite.utils.Constants.THREE_MONTHS_AGO;
import static workshop.akbolatss.xchangesrates.lite.utils.Constants.WEEK_AGO;
import static workshop.akbolatss.xchangesrates.lite.utils.Constants.YEAR_AGO;
import static workshop.akbolatss.xchangesrates.lite.utils.UtilityMethods.getCalculatedBackDays;
import static workshop.akbolatss.xchangesrates.lite.utils.UtilityMethods.getTimestamp;
import static workshop.akbolatss.xchangesrates.lite.utils.UtilityMethods.getTodayDate;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, Callback<CoindeskResponse> {
    ...
    protected void onRefresh() {
        Toast.makeText(this, R.string.tvUpdate, Toast.LENGTH_SHORT).show();
        onUpdateCurrency();
    }
